            ...
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-md-8">
                  ...
                  Fund Source
                  <v-autocomplete v-model="fsd.fs" :items="fund_sources" cache-items hide-no-data return-object outlined
                    item-text="name" item-value="id" dense :rules="[v => !!v || 'Fund Source is required']" multiple
                    clearable chips></v-autocomplete>


                  <v-simple-table>
                  <!--<table class="table table-bordered table-condensed" v-if="fsd">-->
                    <tbody>
                      <tr v-for="(e, i) in sel" :key="i">
                        <td class="col-md-6">{{ e.name }}</td>
                        <td>
  ...
  computed: {
    sumValue() {
      if (this.sel.length > 0) {
        return this.sel.reduce((acc, item) => {
