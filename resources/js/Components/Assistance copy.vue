            ...
            <v-stepper-items>
                ...
                <v-stepper-content step="2">
                    <v-card class="mb-12" flat>
                        ...
                        <v-card outlined>
                            <div class="d-flex flex-no-wrap justify-space-between">
                                ...
                                <div>
                                    ...
                                    <v-card-subtitle>FO11-DSWD-AICS-{{ user.username }} <br> {{ user.birth_date | formatDate
                                    }} <br />
                                        {{ user.mobile_number }}
                                    </v-card-subtitle>
                        ...
                        <div class="container-fluid" id="GIS">
                            <div class="row">
                                <div class="col-md-3">
                            ...
                            <div class="row">
                                <div class="col-md-3">{{ psgc_data.region_name }}</div>
                                <div class="col-md-3">{{ psgc_data.province_name }}</div>
                                <div class="col-md-3">{{ psgc_data.city_name }}</div>
                                <div class="col-md-3">{{ psgc_data.brgy_name }}</div>
                            </div>
