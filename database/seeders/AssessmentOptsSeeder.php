...
class AssessmentOptsSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        foreach ($json as $key => $psgc_data) {
            ...
            $insert_data['option'] = $psgc_data[0];
            $insert_data['problem'] = $psgc_data[1];
            $insert_data['template'] = $psgc_data[2];
    ...
    {
        $reader = Reader::createFromPath(public_path('/dataseeders/gisassessment.csv'), 'r');
