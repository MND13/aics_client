...
<body>
    ...
    <div id="aics-beneficiary-last-name" class="data-textbox">{{ strtoupper($assistance['aics_client']['last_name']) }}
    </div>
    <div id="aics-beneficiary-first-name" class="data-textbox">
        {{ strtoupper($assistance['aics_client']['first_name']) }}</div>
    <div id="aics-beneficiary-middle-name" class="data-textbox">
        {{ strtoupper($assistance['aics_client']['middle_name']) }}</div>
    <div id="aics-beneficiary-ext-name" class="data-textbox">{{ strtoupper($assistance['aics_client']['ext_name']) }}
    </div>

    <div id="aics-beneficiary-street-number" class="data-textbox">
        {{ strtoupper($assistance['aics_client']['street_number']) }}
    </div>
    <div id="aics-beneficiary-psgc-brgy" class="data-textbox">
        {{ strtoupper($assistance['aics_client']['psgc']['brgy_name']) }}
    </div>
    <div id="aics-beneficiary-psgc-city" class="data-textbox">
        {{ strtoupper($assistance['aics_client']['psgc']['city_name']) }}
    </div>
    ...
    <div id="aics-beneficiary-mobile-number" class="data-textbox">
        {{ strtoupper($assistance['aics_client']['mobile_number']) }}
    </div>
    ...
    @if (isset($assistance['assessment']['assessment']))
        <div class="data-textbox"
            style="line-height:1em; top:415pt; left:219pt; width: 300pt; text-align:left; height:80pt; ">
    ...
    @if (isset($assistance['assessment']['purpose']))
        <div id="amount" class="data-textbox" style=" left:20pt; top:640pt; font-size:7pt; line-height:8pt;">
    ...
    @if (isset($assistance['assessment']['amount']))
        <div id="amount" class="data-textbox" style=" right:150pt; top:640pt; font-size:7pt; line-height:8pt;">
            {{ number_format($assistance['assessment']['amount'], 2) }}
        </div>

        <div id="mode_of_assistance" class="data-textbox"
            style=" right:90pt; top:640pt;  font-size:7pt; line-height:8pt;">
            {{ $assistance['assessment']['mode_of_assistance'] }}
        </div>

        <div id="fund_source" class="data-textbox"
            style=" right:8pt; top:640pt; width:80px;  text-align:right; font-size:7pt; line-height:8pt;">

            @if (isset($assistance['assessment']['fund_sources']))
                <table style="table-layout: fixed; width:70px;  text-align:right; " cellpadding=0 cellspacing=0>
                    @foreach ($assistance['assessment']['fund_sources'] as $fs)
                        <tr>
                            <td>{{ $fs['fund_source']['name'] }} =</td>

                            <td style="width:50%">{{ number_format($fs['amount'], 2) }}</td>
                        </tr>
                    @endforeach
            @endif
            </table>
